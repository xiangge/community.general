...
description:
  -  Fetch, comment or change status on bugs of a Bugzilla instance.
...
EXAMPLES = """ # Add a comment to bug: - name: Comment on bug
community.general.bugzilla:     uri: '{{ server }}'     username: '{{ user }}'
password: '{{ pass }}'     bug: '{{ bug.id }}'     operation: comment
